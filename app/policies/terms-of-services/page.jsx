  ...
  return (
    <main>
      <div className={style.container}>
        ...
        <div>Last Revised: 2024-03-11 03:43:07</div>
        <div>
          <h3>1. OVERVIEW</h3>
          <div>
            This Terms of Service Agreement (&quot;Agreement&quot;) is entered
            into by and between Alisa, registered address Block 14, Lot 36,
            Covenant Village, Philippines (&quot;Company&quot;) and you, and is
            made effective as of the date of your use of this website
            https://www.alisa.pics (&quot;Site&quot;) or the date of electronic
            acceptance.
          </div>
          <div>
            This Agreement sets forth the general terms and conditions of your
            use of the https://www.alisa.pics as well as the products and/or
            ...
            <a
              href="https://www.alisa.pics/policies/privacy-policy"
              target="_blank"
            >
              Privacy policy
            </a>
        ...
        <div>
          ...
          <div>
            ...
            found under the laws of the Philippines or other applicable
            jurisdiction.
          </div>
          <div>
        ...
        <div>
          ...
          <div>By using this Site You acknowledge and agree that:</div>
          <ul>
            <li>
          ...
          <div>You will not use this Site in a manner that:</div>
          <ul>
          ...
          <ul>
            ...
            <li>
              ...
              <a
                href="https://termshub.io?utm_source=referral&amp;utm_medium=generated_documents&amp;utm_campaign=referral_documents&amp;utm_content=tos_th_text"
                target="_blank"
              >
                TermsHub.io
              </a>{" "}
        ...
        <div>
          ...
          <div>
            ...
            (&quot;Companies Content&quot;), are owned by or licensed to Alisa
        ...
        <div>
          ...
          <div>
            You shall be solely responsible for any and all of your User Content
            or User Content that is submitted by you, and the consequences of,
            and requirements for, distributing it.
          </div>
          <div>
          ...
          <ul>
            ...
            <li>
              Your User Submissions do not establish a confidential relationship
              or obligate Company to treat your User Submissions as confidential
              or secret.
            </li>
            <li>
              Company has no obligation, either express or implied, to develop
              or use your User Submissions, and no compensation is due to you or
              to anyone else for any intentional or unintentional use of your
              User Submissions.
            </li>
          </ul>
          <div>
            <div>
              ...
              posted to this Site, and shall be entitled to the unrestricted use
              and dissemination of any User Submissions posted to this Site for
            ...
            <div>
              ...
              User Content to enable inclusion and use of the User Content in
              the manner contemplated by this Site and this Agreement.
            </div>
            <div>
              ...
              Site, including without limitation for promoting and
              ...
              without payment or other consideration of any kind, or permission
              or notification, to you or any third party. You also hereby grant
              each User of this Site a non-exclusive license to access your User
              Content through this Site, and to use, reproduce, distribute,
              prepare derivative works of, combine with other works, display,
              and perform your User Content as permitted through the
            ...
            <div>
              ...
              or deleted. The above licenses granted by you in your User Content
              are perpetual and irrevocable.
            </div>
            <div>
              Company generally does not pre-screen User Content but reserves
              the right (but undertakes no duty) to do so and decide whether any
              item of User Content is appropriate and/or complies with this
              Agreement. Company may remove any item of User Content if it
        ...
        <div>
          <h3>14. NO THIRD-PARTY BENEFICIARIES</h3>
          <div>
        ...
        <div>
          <h3>15. COMPLIANCE WITH LOCAL LAWS</h3>
          <div>
        ...
        <div>
          ...
          <div>
            ...
            Philippines, Manila, to the exclusion of conflict of law rules.
          </div>
        </div>
        <div>
          ...
          <div>
            ...
            Philippines, Manila, and judgment on the arbitration award may be
            entered into any court having jurisdiction thereof.
          </div>
        </div>
        <div>
          <h3>18. TITLES AND HEADINGS</h3>
          <div>
